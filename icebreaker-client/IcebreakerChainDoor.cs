...
namespace Manimal.Icebreaker
{
    ...
    [HarmonyPatch(typeof(EFT.InteractionContextHelper), nameof(EFT.InteractionContextHelper.GetAvailableActions), new[] { typeof(GamePlayerOwner), typeof(EFT.Interactive.Switch) })]
