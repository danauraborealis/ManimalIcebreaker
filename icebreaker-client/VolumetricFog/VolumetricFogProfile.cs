...
namespace VolumetricFogAndMist {
	...
	public class VolumetricFogProfile : ScriptableObject {
		...
		[Range(1, 32)] public float lightDiffusionSpread = 8f;
		...
		[Range(0, 0.2f)] public float lightScatteringExposure;
		public Color lightScatteringTint = new Color(1, 1, 1, 0);
		[Range(0, 1f)] public float lightScatteringJittering = 0.5f;
		[Range(0, 5f)] public float lightScatteringBrightnessThreshold = 0f;
		...
		public void Load (VolumetricFog fog) {
			...
			if (lightScatteringOverride) {
				...
				fog.lightDiffusionSpread = lightDiffusionSpread;
				...
				fog.lightScatteringBrightnessThreshold = lightScatteringBrightnessThreshold;
		...
		public void Save (VolumetricFog fog) {
			...
			lightDiffusionSpread = fog.lightDiffusionSpread;
			...
			lightScatteringBrightnessThreshold = fog.lightScatteringBrightnessThreshold;
		...
		public static void Lerp (VolumetricFogProfile profile1, VolumetricFogProfile profile2, float t, VolumetricFog fog) {
			...
			if (profile1.lightScatteringOverride && profile2.lightScatteringOverride) {
				...
				fog.lightDiffusionSpread = profile1.lightDiffusionSpread * (1f - t) * profile2.lightDiffusionSpread * t;
				...
				fog.lightScatteringBrightnessThreshold = profile1.lightScatteringBrightnessThreshold * (1f - t) + profile2.lightScatteringBrightnessThreshold * t;
