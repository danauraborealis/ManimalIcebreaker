...
namespace VolumetricFogAndMist {
    public partial class VolumetricFog : MonoBehaviour {
        ...
        public static class ShaderParams {
            ...
            public static int FogScatteringBrightnessThreshold = Shader.PropertyToID("_FogScatteringBrightnessThreshold");
            public static int FogDiffusionSpread = Shader.PropertyToID("_FogDiffusionSpread");
