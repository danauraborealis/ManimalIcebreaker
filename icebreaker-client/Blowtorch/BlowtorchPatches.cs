...
namespace Manimal.Icebreaker.Blowtorch
{
    ...
    [HarmonyPatch(typeof(ClientUsableItemController), nameof(ClientUsableItemController.CreateAsync))]
    ...
    [HarmonyPatch(typeof(EFT.NextObservedPlayer.ObservedPlayerUsableItemController), nameof(EFT.NextObservedPlayer.ObservedPlayerUsableItemController.GetObservedUsableItem))]
    ...
    [HarmonyPatch(typeof(EFT.NextObservedPlayer.ObservedPlayerHandsController), nameof(EFT.NextObservedPlayer.ObservedPlayerHandsController.GetWeaponAnimationType))]
