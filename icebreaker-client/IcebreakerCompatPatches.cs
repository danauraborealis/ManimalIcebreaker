...
namespace Manimal.Icebreaker
{
    ...
    [HarmonyPatch(typeof(EnemyInfo), nameof(EnemyInfo.GetWeatherK))]
    ...
    [HarmonyPatch(typeof(TripwireSynchronizableObject), nameof(TripwireSynchronizableObject.DisableTripwireByTimer))]
