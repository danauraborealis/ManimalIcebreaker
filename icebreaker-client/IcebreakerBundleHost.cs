...
namespace Manimal.Icebreaker
{
    ...
    //     { c.Counter++; return new BundleLoadOperation { Result = c.AssetBundle }; }
    //     ...
    ...
    internal static class IcebreakerBundleHost
    {
        ...
        // the cache entry (EFT.AssetsManager.BundlesManager+AssetBundleReference) decompiles as a public
